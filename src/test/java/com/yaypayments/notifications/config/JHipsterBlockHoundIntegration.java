package com.yaypayments.notifications.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.yaypayments.notifications.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.yaypayments.notifications.security.DomainUserDetailsService", "createSpringSecurityUser");
